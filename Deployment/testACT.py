...
def run_act(
    ...
    """Run ACT on a provided ARXRobotEnv.
    ...
    policy, preprocess, postprocess, expected_keys, rgb_camera_keys, depth_camera_keys, action_dim, model_chunk_length = load_act_policy(
    ...
    print(
        f"ACT deployment started: side={arm_side}, cameras={rgb_camera_keys}, "
